...
import { Box, Button, Container, Flex, HStack, Image, Input, Link, Menu, MenuButton, MenuItem, MenuList, Modal, ModalBody, ModalContent, ModalHeader, ModalOverlay, SimpleGrid, Spacer, Stack, Text, VStack } from "@chakra-ui/react"
...
export default function Component() {
  ...
  <SimpleGrid columns={[4]} spacingX={`370`} spacingY={`30`}>
  <Box sx={{"height": "150px", "width": "350px", "borderRadius": "10px", "bg": "#1D1D38"}}>
  <Link as={NextLink} href={`http://localhost:3000/video/`}>
  <Box sx={{"display": "flex", "justifyContent": "center", "alignItems": "center", "onHover": "<Text>\n  {`Hover Text`}\n</Text>", "borderRadius": "10px", "height": "150px", "width": "350px", "borderColor": "neonblue", "borderWidth": "3px", "borderStyle": "solid"}}>
  <Image src={`/soccer1.png`} sx={{"height": "auto", "width": "auto", "maxHeight": "100%", "maxWidth": "100%"}}/>
</Box>
</Link>
</Box>
  <Box sx={{"height": "150px", "width": "350px", "borderRadius": "10px", "bg": "#1D1D38"}}>
  <Link as={NextLink} href={`http://localhost:3000/video/`}>
  <Box sx={{"display": "flex", "justifyContent": "center", "alignItems": "center", "onHover": "<Text>\n  {`Hover Text`}\n</Text>", "borderRadius": "10px", "height": "150px", "width": "350px", "borderColor": "neonblue", "borderWidth": "3px", "borderStyle": "solid"}}>
  <Image src={`/soccer2.jpg`} sx={{"height": "auto", "width": "auto", "maxHeight": "100%", "maxWidth": "100%"}}/>
</Box>
</Link>
</Box>
  <Box sx={{"height": "150px", "width": "350px", "borderRadius": "10px", "bg": "#1D1D38"}}>
  <Link as={NextLink} href={`http://localhost:3000/video/`}>
  <Box sx={{"display": "flex", "justifyContent": "center", "alignItems": "center", "onHover": "<Text>\n  {`Hover Text`}\n</Text>", "borderRadius": "10px", "height": "150px", "width": "350px", "borderColor": "neonblue", "borderWidth": "3px", "borderStyle": "solid"}}>
  <Image src={`/soccer3.jpg`} sx={{"height": "auto", "width": "auto", "maxHeight": "100%", "maxWidth": "100%"}}/>
</Box>
</Link>
</Box>
  <Box sx={{"height": "150px", "width": "350px", "borderRadius": "10px", "bg": "#1D1D38"}}>
  <Link as={NextLink} href={`http://localhost:3000/video/`}>
  <Box sx={{"display": "flex", "justifyContent": "center", "alignItems": "center", "onHover": "<Text>\n  {`Hover Text`}\n</Text>", "borderRadius": "10px", "height": "150px", "width": "350px", "borderColor": "neonblue", "borderWidth": "3px", "borderStyle": "solid"}}>
  <Image src={`/soccer4.jpg`} sx={{"height": "auto", "width": "auto", "maxHeight": "100%", "maxWidth": "100%"}}/>
</Box>
</Link>
</Box>
  <Box sx={{"height": "150px", "width": "350px", "borderRadius": "10px", "bg": "#1D1D38"}}>
